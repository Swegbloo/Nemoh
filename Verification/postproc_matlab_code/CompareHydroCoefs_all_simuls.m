...
if TestCaseNo==1       %7_QTF_Cylinder
    dataparamNEMOH1_1;
elseif TestCaseNo==2   %8_QTF_OC4_Semisubmersible
    dataparamNEMOH1_2;
elseif TestCaseNo==3   %9_QTF_SOFTWIND
    dataparamNEMOH1_3;
elseif TestCaseNo==4   %10_QTF_SOFTWIND
    dataparamNEMOH1_4;
end

IDRAO=1; % 0 or 1; 0 not computed
