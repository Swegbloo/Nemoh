...
[pathstr2,~,~] = fileparts(mfilename('C:\Users\swago\OneDrive\Documents\GitHub\Nemoh\matlabRoutines\NemohWrapper'));
addpath(genpath(pathstr2)); % Include the subfolders in the Matlab PATH

[pathstr1,~,~] = fileparts(mfilename('C:\Users\swago\OneDrive\Documents\GitHub\Nemoh\matlabRoutines\cylinder'));
addpath(genpath(pathstr1)); % Include the subfolders in the Matlab PATH
